...
def signup():
    if request.method == "POST":
        ...
        exist_error = User.query.filter_by(username=username).first()
        ...
        if username == "": # Validate Username
            ...
            username = ""
        else: # Validate existing username.
            if exist_error:
                username_error = "Username already taken. Please try another."
                username = ""
